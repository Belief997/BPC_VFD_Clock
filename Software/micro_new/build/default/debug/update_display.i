...
static void write_byte(u8 data){
    u8 i;
    for(i = 0; i < 8; i++){
  LATBbits.LATB5 = (data & 0x80) >> 7;
        LATBbits.LATB0 = PIN_LOW;
  control595_delay();
        LATBbits.LATB0 = PIN_HIGH;
  control595_delay();
        data <<= 1;
    }
}
...
static void write_once(u8 HL, u8 HR, u8 ML, u8 MR){
    ...
    LATBbits.LATB1 = PIN_HIGH;
 control595_delay();
    LATBbits.LATB1 = PIN_LOW;
}

void update_display(void) {
# 73 "update_display.c"
    write_once(0xa5, 0x5a, 0xa5, 0x5a);
    return;
}
